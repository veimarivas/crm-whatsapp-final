            ...
            <div className="block" onClick={(e) => { if (anySelected) { e.preventDefault(); onToggleSelect(deal.id); } }}>
                ...
                {deal.last_message_text && (
                    <p className="text-[11px] text-gray-500 truncate mt-0.5 flex items-center gap-1">
                        ...
                        <span className="truncate">{deal.last_message_text}</span>
                    </p>
                )}
...
export default function Index({ pipelines, pipeline, deals, members, contacts, currency, filters = {}, isAdmin = false }) {
    ...
    // Actualización en vivo: re-trae los deals cada pocos segundos para que un
                                ...
                                >
                                    <div className="rounded-t-2xl px-4 py-3" style={{ background: `${stage.color}1f` }}>
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="text-[10px] font-bold rounded-full px-2 py-0.5" style={{ background: `${stage.color}26`, color: stage.color }}>{stageDeals.length}</span>
                                        </div>
